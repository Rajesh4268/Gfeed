...
public class Shippingfeed {
	...
	public static final String File_TestData = "04OctUsshippingfeed_22.xlsx";
	...
	public static void main(String[] args) throws Exception {
		String currentDirectory = "C:\\Users\\rajesh.r\\Desktop\\TestData\\";
...
//		   WebDriver driver = new ChromeDriver(options);
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//span[@class='labeltext'])[1]")));
			Thread.sleep(2000);
			//shortwaitForVisisble((By.xpath("//span[text()='Upload Artwork']")));
			clickjavascriptelement(driver, driver.findElement(By.xpath("(//span[@class='labeltext'])[1]")));
				}
			} catch (Exception e1)
			{
...
//			}
		...
		try
		{
			...
			//*[@id='cartsummary-heading-2']/div/a
...
//		    	shortwaitForVisisble(By.xpath("//*[@id='__next']/div/div[2]/div[2]/div[2]/div[2]/div[1]/div[2]/div[1]/div[3]/span[2]"));
		   ...
		   //	JOptionPane.showConfirmDialog(null, null);
				...
				System.out.println("actsubtotaldouble "+actsubtotaldouble);
		    if(actsubtotaldouble<=99.00)
		    {
		    	//JOptionPane.showConfirmDialog(null, "if con");
				setExcelFile(Path_TestData + File_TestData, "Input");
